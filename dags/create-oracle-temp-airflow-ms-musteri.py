...
dag = DAG(
    'a-create-oracle-temp-airflow-ms-musteri',
    default_args=default_args,
    description='Oracle üzerinde airflow_ms_musteri tablosunu oluşturur.',
...
create_table_task=OracleOperator(
    ...
    sql='sql/oracle/create-temp-airflow-ms-musteri.sql',
